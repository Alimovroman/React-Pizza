...
import { clearCart, deleteItem, incrementCount, decrementCount, itemsSelector, totalPriceSelector, counterAddPizzasSelector } from "../../../state/cart-reducer";
...
const Cart: React.FC = () => {
  ...
  const counterAddPizzas = useSelector(counterAddPizzasSelector);
  ...
  const onDeleteItem = (index: number, price: number, count: number) => {
    let obj = { index, price, count }
    dispatch(deleteItem(obj));
  }
  const onIncrementCount = (price: number, id: number) => {
    let obj = { price, id }
    dispatch(incrementCount(obj))
  };
  const onDecrementCount = (price: number, id: number) => {
    let obj = { price, id }
          ...
          : <div className="cart">
            ...
            <div className="content__items content__items_cart">
              ...
              {items.map((item: {
                ...
                <CartItem key={i} item={item} i={i} onDeleteItem={onDeleteItem}
                  onIncrementCount={onIncrementCount} onDecrementCount={onDecrementCount} />)}
